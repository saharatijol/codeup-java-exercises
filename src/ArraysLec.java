...
//        System.out.println(names[2]);
        ...
        // System.out.println("prices = " + prices); // ** Only prints its spot in memory **

        System.out.println("prices = " + prices.length + " length");
...
//        System.out.println("prices[2] = " + prices[2]);
        ...
        // ** Most commonly used Arrays.copyOf(array, length) and Arrays.equals(array1, array2)
        Arrays.sort(prices);
        Arrays.sort(names);

        System.out.println("Arrays.names = " + Arrays.toString(names));
        System.out.println("Arrays.price = " + Arrays.toString(prices));
